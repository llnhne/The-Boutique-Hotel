                                                                    ...
                                                                    <div class="slider_parallax_slides">
                                                                        <div class="slide is-active">
                                                                            ...
                                                                            <div class="image-container">
                                                                                <img src="upload/pont-saint-pierre-and-hotel-dieu-saint-jacques-ERV3QDU.jpg" alt="" class="image" />
                                                                            </div>
                                                                        </div>
                                                                        <div class="slide">
                                                                            <div class="slide-content">
                                                                            ...
                                                                            <div class="image-container">
                                                                                <img src="upload/One-Bedroom-Alpine-Suite-Lake-View.jpg" alt="" class="image" />
                                                                            </div>
                                                                        </div>
                                                                        <div class="slide">
                                                                            <div class="slide-content">
                                                                            ...
                                                                            <div class="image-container">
                                                                                <img src="upload/chef-presenting-food-to-customers-in-the-P8DB3B8.jpg" alt="" class="image" />
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="mphb_sc_search-wrapper">
                                                                    <form method="POST" class="mphb_sc_search-form" action="./index.php?act=home">
                                                                        ...
                                                                        <p class="mphb_sc_search-check-in-date">
                                                                            ...
                                                                            <br />
                                                                            <input id="mphb_check_in_date-mphb-search-form-6061a36060295" data-datepick-group="mphb-search-form-6061a36060295" value="date" placeholder="Check-in Date" type="date" name="ngayden" class="ngayden mphb-datepick" autocomplete="off" />
                                                                        </p>
                                                                        ...
                                                                        <p class="mphb_sc_search-check-out-date">
                                                                            ...
                                                                            <br />
                                                                            <input id="mphb_check_out_date-mphb-search-form-6061a36060295" data-datepick-group="mphb-search-form-6061a36060295" value="date" placeholder="Check-out Date" type="date" name="ngaytra" class="ngaytra mphb-datepick" autocomplete="off" />
                                                                        </p>
                                                    ...
                                                    <div class="elementor-element elementor-element-512bfa1 elementor-invisible elementor-widget elementor-widget-image" data-id="512bfa1" data-element_type="widget" data-settings='{"_animation":"fadeInUp","_animation_delay":800,"hoteller_image_is_animation":"false","hoteller_ext_is_scrollme":"false","hoteller_ext_is_smoove":"false","hoteller_ext_is_parallax_mouse":"false","hoteller_ext_is_infinite":"false","hoteller_ext_is_fadeout_animation":"false"}' data-widget_type="image.default">
                                                        <div class="elementor-widget-container">
                                                            <div class="elementor-image">
                                                                <img width="432" height="124" src="upload/signature.png" class="attachment-full size-full" alt="" loading="lazy" />
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="elementor-column-wrap elementor-element-populated">
                                                <div class="elementor-widget-wrap">
                                                    <div class="elementor-element elementor-element-a807720 elementor-widget elementor-widget-image" data-id="a807720" data-element_type="widget" data-settings='{"hoteller_image_is_animation":"false","hoteller_ext_is_scrollme":"false","hoteller_ext_is_smoove":"false","hoteller_ext_is_parallax_mouse":"false","hoteller_ext_is_infinite":"false","hoteller_ext_is_fadeout_animation":"false"}' data-widget_type="image.default">
                                                        <div class="elementor-widget-container">
                                                            <div class="elementor-image">
                                                                <img width="960" height="1440" src="upload/mature-businessman-with-smartphone-in-a-hotel-P8JDE9P.jpg" class="attachment-full size-full" alt="" loading="lazy" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="elementor-column-wrap elementor-element-populated">
                                                <div class="elementor-widget-wrap">
                                                    <div class="elementor-element elementor-element-e4d6ae5 elementor-invisible elementor-widget elementor-widget-image" data-id="e4d6ae5" data-element_type="widget" data-settings='{"_animation":"fadeIn","hoteller_image_is_animation":"false","hoteller_ext_is_scrollme":"false","hoteller_ext_is_smoove":"false","hoteller_ext_is_parallax_mouse":"false","hoteller_ext_is_infinite":"false","hoteller_ext_is_fadeout_animation":"false"}' data-widget_type="image.default">
                                                        <div class="elementor-widget-container">
                                                            <div class="elementor-image">
                                                                <img width="1947" height="555" src="upload/hotel-sketch.png" class="attachment-full size-full" alt="" loading="lazy" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
