                                    ...
                                    <?php foreach ($listpdadat as $item) { ?>
                                        <div class="shadow-lg p-2">
                                            ...
                                            <div class="overflow-hidden ">
                                                <img class=" hover:scale-105 duration-700" style="height: 45rem" src="./upload/<?php echo $item['img'] ?>" alt="">
                                            </div>
                                            <div>
                                        ...
                                        <div class="shadow-lg p-2 ">
                                            ...
                                            <div class="overflow-hidden">
                                                <a class="" href="index.php?act=room&id=<?php echo $item['id_phong'] ?>">
                                                    <img class="hover:scale-110 duration-700" style="height: 45rem" src="./upload/<?php echo $item['img'] ?>" alt="">
                                                </a>
                                            </div>
                                            <div>
